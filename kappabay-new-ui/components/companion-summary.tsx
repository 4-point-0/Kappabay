...
import { useCompanionDeploy } from "@/hooks/use-companion-deploy";
...
export function CompanionSummary({ config, isConfiguring = false, onBack }: CompanionSummaryProps) {
	const router = useRouter();
	// pull in the unified deploy/update logic
	const { handleDeploy, isBusy } = useCompanionDeploy(config);
